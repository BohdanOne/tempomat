    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-tc5gyp");
    			add_location(img, file, 2, 3, 41);
    			attr_dev(h1, "class", "svelte-tc5gyp");
    			add_location(h1, file, 3, 3, 115);
    			attr_dev(div, "class", "main-heading svelte-tc5gyp");
    			add_location(div, file, 1, 2, 11);
    			attr_dev(h2, "class", "svelte-tc5gyp");
    			add_location(h2, file, 5, 1, 143);
    			attr_dev(header, "class", "svelte-tc5gyp");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-ktau3o");
    			add_location(input, file$1, 15, 4, 270);
    			add_location(p, file$1, 21, 4, 367);
    			attr_dev(label, "class", "svelte-ktau3o");
    			add_location(label, file$1, 14, 2, 258);
    			attr_dev(section, "class", "svelte-ktau3o");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-n3zbzb");
    			add_location(main, file$2, 18, 0, 299);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
