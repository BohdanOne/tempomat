...
(function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1euv6wb");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			section = element("section");
    			h3 = element("h3");
    			h3.textContent = "Tempo Marking";
    			t1 = space();
    			p = element("p");
    			t2 = text(/*tempo*/ ctx[0]);
    			add_location(h3, file$3, 21, 2, 606);
    			attr_dev(p, "class", "svelte-64ae8b");
    			add_location(p, file$3, 22, 2, 631);
    			attr_dev(section, "class", "box");
    ...
    class TempoMarkings extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$3, safe_not_equal, { bpm: 1 });
    ...
    function create_fragment$4(ctx) {
    	...
    	const subdivisionpicker = new SubdivisionPicker({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 20, 0, 413);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
